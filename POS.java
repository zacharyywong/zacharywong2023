...
//        System.out.println(test1.tagEntireFile(new BufferedReader(new FileReader("input/patterntexts/simple-test-sentences.txt"))));
        ...
        POS test2 = new POS();
        test2.run("input/patterntexts/brown-train-sentences.txt", "input/patterntexts/brown-train-tags.txt");
        System.out.println(test2.tagEntireFile(new BufferedReader(new FileReader("input/patterntexts/brown-test-sentences.txt"))));
